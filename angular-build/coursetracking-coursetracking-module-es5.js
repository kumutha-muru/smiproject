(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["coursetracking-coursetracking-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddcourseComponent = /** @class */ (function () {
                ...
                AddcourseComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.traineeservice.save(this.course).subscribe(function (result) { return _this.result; }, this.result1 = this.result);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddsubjectComponent = /** @class */ (function () {
                function AddsubjectComponent(router, traineeservice) {
                    this.router = router;
                    this.traineeservice = traineeservice;
                ...
                AddsubjectComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.traineeservice.saveSubject(this.test).subscribe(function (result) { return _this.result; }, this.result1 = this.result);
                };
                AddsubjectComponent.prototype.gotoadd = function () {
                    this.router.navigate(['../coursetracking/add']);
                };
                AddsubjectComponent.prototype.ngOnInit = function () {
                    ...
                    this.traineeservice.getSubjectDetails().subscribe(function (data) { _this.test1 = data; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddtopicComponent = /** @class */ (function () {
                function AddtopicComponent(router, traineeservice) {
                    this.router = router;
                    this.traineeservice = traineeservice;
                    this.test = new _models_issue__WEBPACK_IMPORTED_MODULE_3__["Issue"]();
                }
                AddtopicComponent.prototype.onOptionsSelected = function (value) {
                    var _this = this;
                    this.traineeservice.getCourseSubject(value).subscribe(function (data) {
                        _this.getSubject = data;
                    });
                };
                AddtopicComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.traineeservice.saveTopic(this.test).subscribe(function (result) { return _this.result; }, this.result1 = this.result);
                };
                AddtopicComponent.prototype.gotoadd = function () {
                    this.router.navigate(['../coursetracking/add']);
                };
                AddtopicComponent.prototype.ngOnInit = function () {
                    ...
                    this.traineeservice.getSubjectDetails().subscribe(function (data) { _this.subject = data; });
                    this.traineeservice.getTopicDetails().subscribe(function (data) { _this.topic1 = data; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewcComponent = /** @class */ (function () {
                ...
                ViewcComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.traineeservice.save(this.course1).subscribe(function (result) { return _this.result; });
                    this.traineeservice.saveSubject(this.course1).subscribe(function (result) { return _this.result; });
                    this.traineeservice.saveTopic(this.course1).subscribe(function (result) { return _this.result; });
                };
                ViewcComponent.prototype.ngOnInit = function () {
                    ...
                    this.traineeservice.getSubjectDetails().subscribe(function (data) {
                        _this.course2 = data;
                    });
                    this.traineeservice.getTopicDetails().subscribe(function (data) {
                        _this.course3 = data;
                    });
                };
