(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["trainer-trainer-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddtComponent = /** @class */ (function () {
                function AddtComponent(router, traineeservice) {
                    this.router = router;
                    this.traineeservice = traineeservice;
                    this.trainer = new src_app_models_issue__WEBPACK_IMPORTED_MODULE_4__["Issue"]();
                }
                AddtComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.traineeservice.savetrainer(this.trainer).subscribe(function (result) { return _this.gotoadd(); });
                };
                AddtComponent.prototype.gotoadd = function () {
                    this.router.navigate(['/add']);
                };
                AddtComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.traineeservice.gettrainer().subscribe(function (data) { _this.trainer1 = data; });
                };
                return AddtComponent;
            }());
            AddtComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewtComponent = /** @class */ (function () {
                function ViewtComponent(traineeservice) {
                    this.traineeservice = traineeservice;
                }
                ViewtComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.traineeservice.gettrainer().subscribe(function (data) {
                        _this.trainer = data;
                    });
                };
                return ViewtComponent;
            }());
            ViewtComponent.ctorParameters = function () { return [
